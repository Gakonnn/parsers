...
def get_settings() -> Settings:
    ...
    return Settings(
        ...
        free_plan_jobs_per_month=int(_getenv("BACKEND_FREE_PLAN_JOBS_PER_MONTH", default="-1")),
        free_plan_records_per_month=int(_getenv("BACKEND_FREE_PLAN_RECORDS_PER_MONTH", default="50")),
